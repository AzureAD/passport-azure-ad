...
Strategy.prototype.authenticate = function(req, options) {
  ...
  // 
  // NOTE: It's important all options are in self._options before we continue, as we'll be validating these and
  ...
  if (options.responseMode) { self_options.responseMode = options.responseMode; }
